local function set_bot_photo(msg, success, result)
  ...
  if success then
    ...
    send_large_msg(receiver, 'عکس جدید نصب شد!', ok_cb, false)
    redis:del("bot:photo")
  else
    print('Error downloading: '..msg.id)
    send_large_msg(receiver, 'در دانلود مشکلی پیش آمد لطفا دوباره امتحان کنید!', ok_cb, false)
  end
end
...
local function run(msg,matches)
    ...
    if matches[1] == "setbotphoto" then
    	...
    	return 'لطفا عکس جدید مرا ارسال کنید'
    end
    ...
    if matches[1] == "contactlist" then
      ...
      return "لیست شماره های من به خصوصی شما در قالب json ارسال شد"
    end
    if matches[1] == "addcontact" and matches[2] then    add_contact(matches[2],matches[3],matches[4],ok_cb,false)
      return "شماره "..matches[2].." در لیست مخاطبین ذخیره شد"
    end
    ...
    if matches[1] == "dialoglist" then
      ...
      return "فعالیت های گروه ها در قالب فایل به خصوصی شما ارسال شد"
    end
